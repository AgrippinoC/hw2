@extends('layout1')
@section('title', 'hw2 - Azienda Agricola Gagliano')
@section('script')
<script src='{{ URL::to("hw2-home.js") }}' defer></script>
<script>
        const PREF = "{{ URL::to('home/save_orange') }}";
...
@section('content')
       ...
       <section data-nome="Tarocco">
        ...
        <div class="foto"><img src='{{ URL::to("IMG/tarocco.jpg") }}'/></div>
        <form>@csrf<img id="like" src='{{ URL::to("IMG/dislike.png") }}'/></form>  
      </section>
      ...
      <section data-nome="Washington">
        ...
        <div class="foto"><img src='{{ URL::to("IMG/washington.jpg") }}'/></div>
	      <form>@csrf<img id="like" src='{{ URL::to("IMG/dislike.png") }}'/></form>  
      </section>
      ...
      <section data-nome="Moro">
       ...
       <section data-nome="Novellino">
        ...
        <div class="foto"><img src='{{ URL::to("IMG/novellino.jpg") }}'/></div>
        <form>@csrf<img id="like" src='{{ URL::to("IMG/dislike.png") }}'/></form>  
	</section>
